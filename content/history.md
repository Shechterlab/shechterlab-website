  ...
  - block: markdown
    content:
      ...
      text: |
        ...
        Haeun Kim (PhD, PRMT9/TDP-43/ALS) and Liana Valin (MSTP) join the lab. Isaac Kraz and collaborators post the GNMT N-terminus preprint on bioRxiv, framing GNMT as the supply-side regulator in the methyl economy. Jacob Roth's paper on PRMT5-dependent histone production is under invited revision at *Nature Communications*, with a *Nature Structural and Molecular Biology* News and Views. The TTLL4/NPM1c AML paper is also under revision at *Nature Communications*.
        ...
        Glutamylation of NPM2 and NAP1 published — showing that TTLL4-dependent polyglutamylation of histone chaperone acidic domains increases DNA charge mimicry and enhances chaperone activity. Aliza Silverstein (MD-PhD) joins the lab, working on PRMT5 and the GRIPP pathway.

        ## 2022–2023

        Type I and Type II PRMT inhibitor paper published in *eLife*, characterizing the differential effects of symmetric vs. asymmetric arginine dimethylation on chromatin and RNA processing. ALS collaboration with ALS-TDI deepens around C9orf72 and protein arginine methylation.

        ## 2021

        Maron et al. published in *iScience* on PRMTs and mRNA processing. Jacob Roth and Isaac Kraz join as MSTP graduate students. Humaira Ilyas joins as a postdoctoral fellow. Emmanuel Burgos transitions out of the lab after seven years.
