    ...
    content:
      ...
      text: |
        ...
        **Lab members:** [Lab Wiki ↗](https://wiki.shechterlab.org)
        ...
        <p>
          Shechter Lab<br>
          <a href="https://einsteinmed.edu/departments/biochemistry">Department of Biochemistry</a><br>
          Albert Einstein College of Medicine<br>
          Forchheimer Building, Room 304<br>
        ...
        <form name="contact" method="POST" data-netlify="true" netlify-honeypot="bot-field" action="/thanks/" class="hb-form not-prose">
          ...
          <input type="hidden" name="subject" value="Shechter Lab website — contact form">
        ...
        If the form gives you any trouble, email [david.shechter@einsteinmed.edu](mailto:david.shechter@einsteinmed.edu) directly.
---
